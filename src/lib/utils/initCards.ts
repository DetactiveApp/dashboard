...
export const initStepCard: Card = { type: "STEP", data: { title: "", description: "", mediaType: "NONE", assetId: null, waypoint: { placeType: "none", placeOverride: false } }, offset: [0, 0], anchors: [], deleted: false };
